...
public interface NoticeService {
	...
	public void updateNoticeInfo(HttpServletRequest request, Authentication authentication, Integer noticeNo , String noticeTitle, String noticeContent, String category);
}
